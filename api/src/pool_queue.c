...
extern int semaphore_init(UvisorSemaphore * semaphore, int32_t count);
extern int semaphore_pend(UvisorSemaphore * semaphore, uint32_t timeout_ms);
extern int semaphore_post(UvisorSemaphore * semaphore);

extern void spin_init(UvisorSpinlock * spinlock);
extern bool spin_trylock(UvisorSpinlock * spinlock);
extern void spin_lock(UvisorSpinlock * spinlock);
extern void spin_unlock(UvisorSpinlock * spinlock);
